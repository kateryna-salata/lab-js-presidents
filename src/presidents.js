...
function getNames(presidentsArr) {
    const presidentsNames = presidentsArr.map((onePresident) => onePresident.name);
...
function getDemocraticPresidents(presidentsArr) {
  const democraticPresidents = presidentsArr.filter (onePresident => onePresident.party === "Democratic");
